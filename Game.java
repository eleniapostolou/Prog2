...
abstract public class Game {
 ...
 //ΕΡΩΤΗΣΕΙΣ ΑΠΑΝΤΗΣΕΙΣ ΠΕΡΣΕΦΟΝΗΣ
   ...
   questions[3][3] = "Δικαστήριο της Αρχαίας Αθήνας (2 λέξεις ενωμένες)";
   ...
   questions[3][9] = "Είχε χαάλκινο σώμα";
   ...
   questions[3][13] = "Συναντήθηκε με τους Αργοναύτες, που γύριζαν από την Κολχίδα και προσπάθησε να τους κρατήσει σε απόσταση ρίχνοντας βράχους πάνω στην «Αργώ».";
   questions[3][14] = null;
   questions[3][15] = "Από τα κρύα έφυγε και πήγε εξορία, σε σπίτι άλλου έμπλεξε, δεν είχε στον ήλιο μοίρα. ποιός ήταν;";
   questions[3][16] = "Η φύση του τα χάρισε, η φύση του τα πήρε, ελευθερία του έταξε μα προδωσία βρήκε. Τι είναι;";
   questions[3][17] = "Καθρεύτης ήταν του ουρανού και όμορφο φαινόταν. Τον Ίκαρο αφάνησε, μα το όνομά του ακουγόταν. Ποιό είναι;";
